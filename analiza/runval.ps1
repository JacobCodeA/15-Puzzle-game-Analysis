...
$Progcmd = 'python C:\Users\jakub\Desktop\sztucznaInteligecjaISystemyEkspertowe\zadanie1\program.py'
...
$Param = $SplitFilename[4].ToUpper()
$StatsFilename = $_.Name.Replace('_sol.txt', '_stats.txt')

Invoke-Expression $('{0} {1} {2} {3} {4} {5}' -f $Progcmd, $Strategy, $Param, $InitFilename, $_.Name, $StatsFilename)
